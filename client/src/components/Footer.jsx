                    ...
                    <div className='grid grid-cols-2 gap-8 mt-4 sm:grid-cols-3 sm:gap-6'>
                        <div>                            
                            ...
                            <Footer.LinkGroup col>
                                <Footer.Link 
                                    href='https://my-portfolio-tp31.onrender.com/' 
                                    target='_blank'
                        ...
                        <div>                            
                            <Footer.Title title='Folow Me' />
                            <Footer.LinkGroup col>
                                <Footer.Link
                                    href='https://www.linkedin.com/in/david-kenyi-6a13a5b6/'
                                    target='_blank'
                                    rel='noopener noreferrer'
                                >
                                    LinkedIn
                                ...
                                <Footer.Link 
                                    href='https://github.com/johnnyalier'
                                    target='_blank'
                                    rel='noopener noreferrer'
                                >
                                    Github
